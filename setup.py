...
extra_reqs = {
    ...
    "deploy": [
        ...
        "aws-cdk.aws_lambda==1.108.0",
        "aws-cdk.aws_apigatewayv2==1.108.0",
        "aws-cdk.aws_apigatewayv2_integrations==1.108.0",
        "aws-cdk.aws_ecs==1.108.0",
        "aws-cdk.aws_ec2==1.108.0",
        "aws-cdk.aws_autoscaling==1.108.0",
        "aws-cdk.aws_ecs_patterns==1.108.0",
        "aws-cdk.aws_iam==1.108.0",
        "aws-cdk.aws_elasticache==1.108.0",
    ],
